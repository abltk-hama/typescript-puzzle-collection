...
describe('Sudoku puzzle data',()=>{
  ...
  it('resolves bundled data under the configured base path',()=>expect(bundledPuzzlesUrl('/typescript-puzzle-collection/')).toBe('/typescript-puzzle-collection/puzzles/sudoku/puzzles.json'))
})
